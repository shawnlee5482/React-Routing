...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function () {
	    ...
	    if (this.props.route == "form") {
	      return React.createElement(
	        ...
	        React.createElement(NinjaForm, { route: this.props.route })
	      );
	    } else {
	      return React.createElement(
	        'div',
	        ...
	        React.createElement(NinjaHome, { route: this.props.route })
	      );
	    }
	  }
	});
	...
	window.onhashchange = function () {
	  ...
	  ReactDOM.render(React.createElement(App, { route: location.hash.substr(2) }), document.getElementById('app'));
	};

	ReactDOM.render(React.createElement(App, { route: "home" }), document.getElementById('app'));
